...
import { ArrowRight, Video, Mic, FileText, Clock } from "lucide-react"
...
export default function FullSimulationPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (domain && interviewType) {
      ...
      // Add either numQuestions or duration based on mode
      if (interviewMode === "questions") {
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="questions" id="questions-mode" />
                      <Label htmlFor="questions-mode">Set number of questions</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="duration" id="duration-mode" />
                      <Label htmlFor="duration-mode">Set interview duration</Label>
                    </div>
                  </RadioGroup>
                </div>
          ...
          <TabsContent value="info">
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  Choose between a fixed number of questions or a timed interview. You can set up to 50 questions or a
                  time limit between 5 and 120 minutes to simulate real interview conditions.
                </p>
              </div>
