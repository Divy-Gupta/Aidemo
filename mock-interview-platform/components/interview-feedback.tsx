...
export default function InterviewFeedback({ question, answer }: InterviewFeedbackProps) {
      ...
      <CardContent className="space-y-4">
        <div className="flex flex-wrap gap-2 mb-2">
          <Badge variant="outline" className="bg-green-50 text-green-700 dark:bg-green-900 dark:text-green-300">
            Content: {mockFeedback.contentScore}/100
          </Badge>
          <Badge variant="outline" className="bg-blue-50 text-blue-700 dark:bg-blue-900 dark:text-blue-300">
            Delivery: {mockFeedback.deliveryScore}/100
          </Badge>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400">{mockFeedback.idealAnswer}</p>
          </div>
        </div>
      </CardContent>
    </Card>
